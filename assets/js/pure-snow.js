...
function toggleSnow() {
  var button = document.getElementById("toggle-snow");

  if (button.getAttribute("data-state") === "true") {
    button.setAttribute("data-state", "false");
    button.style.color = "white";
    button.style.backgroundColor = "red";
    button.textContent = "Kar Yağışı Aç";
  } else {
    button.setAttribute("data-state", "true");
    button.style.color = "red";
    button.style.backgroundColor = "white";
    button.textContent = "Kar Yağışı Kapat";
  }

  showSnow(button.getAttribute("data-state") === "true");
}
